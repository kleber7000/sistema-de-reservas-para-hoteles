...
<?php _t("Editar _traducciones"); ?></h2> 
 ...
 <div class="form-group"> 
     ...
     <div class="col-sm-10"> 
       <input type="text" class="form-control" name="_traducciones_contenido_id" id="_traducciones_contenido_id" placeholder="<?php _t("Contenido_id"); ?>" value="<?php echo $_traducciones_contenido_id; ?>"   > 
     </div> 
   </div> 
