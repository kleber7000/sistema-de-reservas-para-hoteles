...
<input type="hidden" name="a" value="crear"> 
 ...
 <div class="form-group"> 
     ...
     <div class="col-sm-10"> 
       <input type="text" class="form-control" name="empresas_sitio_web" id="empresas_sitio_web" placeholder="<?php _t("Sitio_web"); ?>" value=""   > 
     </div> 
   </div> 
 ...
 <div class="form-group"> 
     ...
     <div class="col-sm-10"> 
       <input type="text" class="form-control" name="empresas_nombre" id="empresas_nombre" placeholder="<?php _t("Nombre"); ?>" value=""   > 
     </div> 
   </div> 
 ...
 <div class="form-group"> 
     ...
     <div class="col-sm-10"> 
       <input type="text" class="form-control" name="empresas_tipo" id="empresas_tipo" placeholder="<?php _t("Tipo"); ?>" value=""   > 
     </div> 
   </div> 
 ...
 <div class="form-group"> 
     ...
     <div class="col-sm-10"> 
       <input type="text" class="form-control" name="empresas_pais" id="empresas_pais" placeholder="<?php _t("Pais"); ?>" value=""   > 
     </div> 
   </div> 
 ...
 <div class="form-group"> 
     ...
     <div class="col-sm-10"> 
       <input type="text" class="form-control" name="empresas_provincia" id="empresas_provincia" placeholder="<?php _t("Provincia"); ?>" value=""   > 
     </div> 
   </div> 
 ...
 <div class="form-group"> 
     ...
     <div class="col-sm-10"> 
       <input type="text" class="form-control" name="empresas_ciudad" id="empresas_ciudad" placeholder="<?php _t("Ciudad"); ?>" value=""   > 
     </div> 
   </div> 
 ...
 <div class="form-group"> 
     ...
     <div class="col-sm-10"> 
       <input type="text" class="form-control" name="empresas_cpostal" id="empresas_cpostal" placeholder="<?php _t("Cpostal"); ?>" value=""   > 
     </div> 
   </div> 
 ...
 <div class="form-group"> 
     ...
     <div class="col-sm-10"> 
       <input type="text" class="form-control" name="empresas_direccion" id="empresas_direccion" placeholder="<?php _t("Direccion"); ?>" value=""   > 
     </div> 
   </div> 
 ...
 <div class="form-group"> 
     ...
     <div class="col-sm-10"> 
       <input type="text" class="form-control" name="empresas_tel" id="empresas_tel" placeholder="<?php _t("Tel"); ?>" value=""   > 
     </div> 
   </div> 
 ...
 <div class="form-group"> 
     ...
     <div class="col-sm-10"> 
       <input type="text" class="form-control" name="empresas_fax" id="empresas_fax" placeholder="<?php _t("Fax"); ?>" value=""   > 
     </div> 
   </div> 
 ...
 <div class="form-group"> 
     ...
     <div class="col-sm-10"> 
       <input type="text" class="form-control" name="empresas_email" id="empresas_email" placeholder="<?php _t("Email"); ?>" value=""   > 
     </div> 
   </div> 
 ...
 <div class="form-group"> 
     ...
     <div class="col-sm-10"> 
       <input type="text" class="form-control" name="empresas_twitter" id="empresas_twitter" placeholder="<?php _t("Twitter"); ?>" value=""   > 
     </div> 
   </div> 
 ...
 <div class="form-group"> 
     ...
     <div class="col-sm-10"> 
       <input type="text" class="form-control" name="empresas_google_plus" id="empresas_google_plus" placeholder="<?php _t("Google_plus"); ?>" value=""   > 
     </div> 
   </div> 
 ...
 <div class="form-group"> 
     ...
     <div class="col-sm-10"> 
       <input type="text" class="form-control" name="empresas_facebook" id="empresas_facebook" placeholder="<?php _t("Facebook"); ?>" value=""   > 
     </div> 
   </div> 
 ...
 <div class="form-group"> 
     ...
     <div class="col-sm-10"> 
       <input type="text" class="form-control" name="empresas_linkedin" id="empresas_linkedin" placeholder="<?php _t("Linkedin"); ?>" value=""   > 
     </div> 
   </div> 
 ...
 <div class="form-group"> 
     ...
     <div class="col-sm-10"> 
       <input type="text" class="form-control" name="empresas_empresa_contacto" id="empresas_empresa_contacto" placeholder="<?php _t("Empresa_contacto"); ?>" value=""   > 
     </div> 
   </div> 
 ...
 <div class="form-group"> 
     ...
     <div class="col-sm-10"> 
       <input type="text" class="form-control" name="empresas_empresa_contacto_email" id="empresas_empresa_contacto_email" placeholder="<?php _t("Empresa_contacto_email"); ?>" value=""   > 
     </div> 
   </div> 
