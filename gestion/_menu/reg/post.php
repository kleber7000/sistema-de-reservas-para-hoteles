 <?php 
  ...
  $_menu_url = mysql_real_escape_string($_POST['_menu_url']); 
  $_menu_icono = mysql_real_escape_string($_POST['_menu_icono']); 
  $_menu_orden = mysql_real_escape_string($_POST['_menu_orden']); 
