            ...
            <form method="post" action="index.php" >
                ...
                <tr> <td><input class="form-control" type="text" name="contactos_id_manager" value="" placeholder="<?php _t("Id_manager"); ?>"></td> 
 <td><input class="form-control" type="text" name="contactos_sexo" value="" placeholder="<?php _t("Sexo"); ?>"></td> 
 <td><input class="form-control" type="text" name="contactos_nombres" value="" placeholder="<?php _t("Nombres"); ?>"></td> 
 <td><input class="form-control" type="text" name="contactos_apellidos" value="" placeholder="<?php _t("Apellidos"); ?>"></td> 
 <td><input class="form-control" type="text" name="contactos_cedula" value="" placeholder="<?php _t("Cedula"); ?>"></td> 
 <td><input class="form-control" type="text" name="contactos_pais" value="" placeholder="<?php _t("Pais"); ?>"></td> 
 <td><input class="form-control" type="text" name="contactos_provincia" value="" placeholder="<?php _t("Provincia"); ?>"></td> 
