...
<input type="hidden" name="a" value="crear"> 
 ...
 <div class="form-group"> 
     ...
     <div class="col-sm-10"> 
        <select class="form-control" name="contactos_id_manager" >
 ...
 <div class="form-group"> 
     ...
     <div class="input-group"> 
       <input type="text" class="form-control" name="contactos_fecha_nacimiento" id="contactos_fecha_nacimiento" placeholder="<?php _t("aaaa-mm-dd"); ?>" value=""   > 
